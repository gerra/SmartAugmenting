...
public class LinearLayoutManager extends android.support.v7.widget.LinearLayoutManager {
    ...
    public int getCompletelyVisibleCount() {
    ...
    public boolean allItemsAreCompletelyVisible() {
        return getCompletelyVisibleCount() == getItemCount();
    }

    public boolean allItemsAreVisible() {
        int firstVisible = findFirstVisibleItemPosition();
        int lastVisible = findLastVisibleItemPosition();
        return lastVisible - firstVisible + 1 == getItemCount();
    }

    @Override
    public boolean canScrollVertically() {
        return !allItemsAreCompletelyVisible();
    }
